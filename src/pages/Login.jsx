                    ...
                    >
                        ...
                        <Box   noValidate sx={{ mt: 1 }} style = {{display:'block',width:'90%'}}>
                            ...
                            <div className="login__social">
                                <a href = "http://localhost/api/auth/google"  className="login__social__button login__social__button__fb">
                                ...
                                <a href = "http://localhost/api/auth/facebook" className="login__social__button login__social__button__gg">
